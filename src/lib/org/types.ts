// ---------------------------------------------------------------------------
// org/types.ts — Core types for the Summit Org OS
//
...
//
// Design decision: every department's pipeline runs through its boss, but
// the OWNER keeps the final approve trigger until he's comfortable
// graduating a boss.
// ---------------------------------------------------------------------------
...
/**
 * An employee of Summit — an AI staff member with a real position
...
export interface Employee {
   ...
   * reports straight to the owner (Chris), so deliverables go
