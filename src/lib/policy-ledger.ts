...
//
// This is what makes the Controller get smarter over
...
// into the CFO's system prompt as "Established Summit Accounting Policies", so a
...
export interface AccountingPolicy {
  ...
  context?: string;
  /** Who decided it — usually "Chris Cook", sometimes the Controller. */
  decidedBy: string;
...
export async function renderPolicyBlock(): Promise<string> {
  ...
  return [
    "ESTABLISHED SUMMIT ACCOUNTING POLICIES:",
