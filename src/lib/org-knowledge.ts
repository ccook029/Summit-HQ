...
//
// One editable document of Summit facts Chris teaches ONCE — the business
// brief, the ICP, "we're cash-basis on payables", voice rules, who's who —
// and every employee reads it in every run and every chat. No more teaching the same fact to each agent separately.
//
 ...
 *   1. THE SUMMIT ETHOS — foundational reasoning, always present (baked in code
 ...
 * new department engine and legacy pipeline — think the Summit way.
 */
export async function renderOrgKnowledge(): Promise<string> {
  ...
  const knowledgeBlock = knowledge
    ? [
        "",
        "=== SUMMIT COMPANY KNOWLEDGE (specific facts Chris has taught — authoritative) ===",
